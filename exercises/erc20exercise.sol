...
contract ERC20 {
  // modifying the ERC-20 Token contract so more than 1 million tokens are minted in to circulation
  ...
  function mint(uint256 amount) public validCirculation {
  ...
  // Modifier to check totalsupply
  modifier validCirculation() {
    require(
      totalSupply < 1000000,
      'Total Supply is greater than 1M, mininting cannot be done again'
    );
    _;
  }
}
